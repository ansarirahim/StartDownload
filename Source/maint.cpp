...
//////////////////////////////clem file crc/////
ifstream infile10("/root/CLem/SAveClemFlashCrc/ClemFileFlashCRC");
string sLine10;
if(infile10.good())
...
infile10.close();
cout<<"\nsline="<<sLine10<<endl;
Crc_File_Buffer[0]=atoi(sLine10.c_str());
...
printf("\nCrc_Buffer=%d Crc_File_buffer=%d",Crc_Buffer[0],Crc_File_Buffer[0]);
