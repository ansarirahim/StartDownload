...
////\	std::cout <<"Read Clem line by line\n";
 ...
 ifstream infile;
///////////////////////////
///root/CLem/SAveClemFile/main ClemFilePath
ifstream infile1("/root/CLem/SAveClemFile/ClemFilePath");///"test.txt");
string sLine11;//
//int i1==0;
  if (infile1.good())
  {
    ////string sLine11;
    getline(infile1, sLine11);

   cout <<"\nclemfilepath="<< sLine11 << endl;
  }
else
{
cout<<"\nclem file path setting file not found"<<endl;
  infile1.close();
return -1;
}
//////////////////////
...
///////////////////////////
infile.open (sLine11.c_str());///"/home/0004564.j2A");
if(infile.good()){
}
else
{
cout<<"\nClem file path error  ..clem file not found on the  provided path"<<endl;
return -1;
}
aclem=0;
	 HowManyFpages=0;
...
//////printf("\nCrcFbuffer=%d",Crc_Buffer[0]);
/////CLem/SAveClemFlashCrc# nano ClemFileFlashCRC

string line3;
  ifstream myfile3 ("/root/CLem/SAveClemFlashCrc/ClemFileFlashCRC");
  if (myfile3.is_open())
  {
 ...
 ///// else cout <<"NACK"<<endl;//// "Unable to open file"; 
//////////////
    ////file3.close();
printf("\ncrcbuffer=%d,filecrc=%s",Crc_Buffer[0],line3.c_str());///
if(atoi(line3.c_str())!=Crc_Buffer[0])
{
cout<<"crc is not matched file and buffer \n\rNACK"<<endl;
///return 0;
return -1;
}
